  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        const parsed = mapAvailability(availability, nights, search.rooms)
        ...
        const parsedInitial = mapAvailability(availability, nights, search.rooms);
        if (cancelled || requestSeq !== activeRequestSeq.current) return;
        ...
        if (shouldPollMore) {
          ...
          for (let attempt = 0; attempt < HYBRID_MAX_POLLS; attempt += 1) {
            ...
            try {
              ...
              const parsedPoll = mapAvailability(polledAvailability, nights, search.rooms);
              if (cancelled || requestSeq !== activeRequestSeq.current) break;
