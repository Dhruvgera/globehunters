...
const PACKAGE_REFUND_SHIELD_FEATURES = [
...
export function PackageRefundShieldSection({
  selected,
  onToggle,
  price,
  currency,
}: PackageRefundShieldSectionProps) {
  return (
    <div className="bg-white border-2 border-[#3754ED] rounded-xl p-4 flex flex-col gap-4">
      ...
      >
        ...
        <div className="mt-4 grid gap-2 sm:grid-cols-2">
          {PACKAGE_REFUND_SHIELD_FEATURES.map((feature) => (
